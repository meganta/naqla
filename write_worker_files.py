...
with open("services/worker/pyproject.toml", "w") as f:
    f.write(pyproject)
print("pyproject.toml written")

ingestion_py = """import io
import json
import os
import tempfile
...
with open("services/worker/handlers/ingestion.py", "w") as f:
    f.write(ingestion_py)
print("handlers/ingestion.py written")
