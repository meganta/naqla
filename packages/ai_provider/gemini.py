...
from packages.ai_provider.base import AIMessage, AIProvider, AIResponse
...
class GeminiProvider(AIProvider):
    ...
    async def complete(
        ...
        return AIResponse(text=text, tokens_used=tokens_used, model=self.model_name, provider="gemini")
